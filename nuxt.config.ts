  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://play.sycamore.ng/Asset_Emblem.png' },
        { property: 'og:image:width', content: '1040' },
        { property: 'og:image:height', content: '1150' },
        ...
        { name: 'twitter:image', content: 'https://play.sycamore.ng/Asset_Emblem.png' },
      ],
      link: [
